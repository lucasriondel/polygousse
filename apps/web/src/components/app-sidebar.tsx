...
export function AppSidebar({
	...
	async function handleCreate(name: string, folderPath: string, icon?: string | null, linearTeamId?: string | null) {
		const workspace = await onCreate(name, folderPath, icon, linearTeamId);
		await navigate({
